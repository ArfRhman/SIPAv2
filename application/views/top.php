                                                    ...
                                                    <? if($id_jenis== 3 || $id_jenis== 5 || $id_jenis== 6){
                                                        ...
                                                        <? if($id_jenis== 3 || $id_jenis== 5){
                                                            ...
                                                            <? if($id_jenis== 3 || $id_jenis== 6){
                                                                ...
                                                                <? if($id_jenis== 3 || $id_jenis== 5 || $id_jenis == 7){
                                                                    ...
                                                                    <? if($id_jenis== 3 || $id_jenis== 5){
                                                                        ...
                                                                        <? if($id_jenis== 3 || $id_jenis== 5){
                                                                            ...
                                                                            <a href="<?=site_url()?>">
                                                                                <li class="list-group-item">
                                                                                    <span class="badge"><?= $jmlUsul ?></span> <i class="fa fa-check"></i> Paket Gagal Lelang
                                                                                </li>
                                                                            </a>
                                                                            <? } } ?>
                                                                            ...
                                                                            <? if($id_jenis== 3 || $id_jenis== 5 || $id_jenis==8){
                                                                                ...
                                                                                <? if($id_jenis== 3 || $id_jenis== 5 || $id_jenis==9){
                                                                                    ...
                                                                                    <? if($id_jenis== 1 || $id_jenis== 10 || $id_jenis== 2 || $id_jenis== 3){
