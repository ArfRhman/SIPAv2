            ...
            <div class="card">
              <div class="card-header">
                <div class="card-title">
                  <span class="title">Konfirmasi Penerimaan Alat</span>
                </div>
              </div>
              <div class="card-body">
                <table class="table table-stripped table-bordered table-hover">
                  ...
                  foreach ($pnb as $p) {
                    ...
                    if(!empty($cekJur[0]['ID_ALAT'])){ 
                      ...
                      <td> <?$tgl = explode(" ", $p['TANGGAL_PENERIMAAN']); echo IndoTgl($tgl[0]);?></td> 
                      ...
                      <td>
                        ...
                        <?}else{?>
                        <span class="label label-success" style="font-size: 11px;"><i class="fa fa-check"></i> Penerimaan Diapprove</span>
                        <?}?>
                      </td>
                    </tr>
                    <?} }?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form enctype="multipart/form-data" action="<?=base_url()?>SPM/approvePenerimaan" method="POST">
