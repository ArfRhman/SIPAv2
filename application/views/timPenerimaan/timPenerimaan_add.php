            ...
            <div class="card">
              <div class="card-header">
                <div class="card-title" style="width:100%">
                  <span class="title">Tambah Tim Penerimaan</span>
                  <a href="<?=site_url()?>BeritaAcara/TimPenerimaan" class="btn btn-primary pull-right"><i class="fa fa-chevron-left"></i> Kembali </a>
